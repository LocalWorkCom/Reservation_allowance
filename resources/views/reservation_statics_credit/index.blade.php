...
@section('content')
                    ...
                    <div class="row" style="direction: rtl">
                        ...
                        <div class="col-12 div-info">
                            <div class="row">
                                ...
                                <div class="col-12 div-info-padding"><b>الادارة الرئيسية : <span>{{ $mainDepartment }}</span></b></div>
                                <div class="col-12 div-info-padding"><b>الادارة الفرعية : <span>{{ $subDepartment }}</span></b></div>
                                ...
                                <div class="col-12 div-info-padding"><b>ميزانيه بدل الحجز : <span>{{ number_format($reservationAllowanceBudget, 2) }}</span></b></div>
                                <div class="col-12 div-info-padding"><b>مبالغ مسجله : <span>{{ number_format($recordedAmounts, 2) }}</span></b></div>
                                <div class="col-12 div-info-padding"><b>المتبقي : <span>{{ number_format($remainingAmount, 2) }}</span></b></div>
                            </div>
                        </div>
                        </div>
                    </div>
    ...
    <div class="row">
        <div class="container col-11 mt-3 p-0 pt-5 pb-4">
            <div class="col-lg-12">
                <div class="bg-white">
                    <h3>احصائيات بدل حجز شهر {{ $currentMonth }}</h3>
...
<script>
    $(document).ready(function() {
        ...
        $('#credit-table').DataTable({
            ...
            columns: [
                { data: null, name: 'order', orderable: false, searchable: false }, // Automatic numbering column
                { data: 'day', name: 'day' },
