...
<main>
        ...
        <div class="container  col-11" style="background-color:transparent;">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    @else
                    <li class="breadcrumb-item"><a href="{{ route('departments.index', $department->sectors->uuid) }}">
                            {{-- {{ $department->name }} --}} الأدارات
                        </a></li>
                    @endif
    ...
    <div class="row">
        <div class="container  col-11 mt-3 py-4 ">
                    ...
                    <div class="form-group col-md-12 mx-md-2">
                        ...
                        <div class="d-flex mt-3 " dir="rtl">
                            ...
                            <label for="part"> حجز كلى</label><input type="checkbox" class="toggle-radio-buttons mx-2"
                                value="2" id="partialBooking" name="part[]">
            ...
            <div class="form-group col-md-12 mx-md-2" dir="rtl">
                ...
                <div class="d-flex mt-3">
                    <label for="notFree" class="d-flex align-items-center">
                        <input type="radio" class="toggle-radio-buttons " name="budget_type" value="1" id="notFree"
                            style="height:20px;"> ميزانيه محدده

                    </label>

                    <label for="free" class="d-flex align-items-center">
                        <input type="radio" class="toggle-radio-buttons me-2" name="budget_type" value="2" id="free"
            ...
            <div class="form-group col-md-12 mx-md-2" id="budgetField" style="display: none;">
