...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/statistics_credit', [ReservationStaticsCreditController::class, 'static'])->name('Reserv_statistic_credit.static')->middleware('check.permission:view Inspector');
