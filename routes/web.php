...
Route::middleware(['auth'])->group(function () {
    ...
    Route::any('/reservation_allowances/getAllWithMonth', [ReservationAllowanceController::class, 'getAllWithMonth'])->name('reservation_allowances.getAllWithMonth')->middleware('check.permission:view Inspector');
