    ...
    <div class="navbar navbar-expand-md mb-4" role="navigation" dir="rtl">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <ul class="navbar-nav d-flex justify-content-between w-100">
                ...
                <li class="nav-item {{ request()->routeIs('reservation_allowances') || request()->routeIs('reservation_allowances.index') || request()->routeIs('reservation_allowances.create') || request()->routeIs('Reserv_statistic_credit.index') ? 'active' : '' }}"
