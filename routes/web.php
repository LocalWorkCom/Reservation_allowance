...
Route::middleware(['auth'])->group(function () {
    ...
    Route::any('/reservation_allowances/get_departement_with_all/{id}/{type}', [ReservationAllowanceController::class, 'get_departement_with_all'])->name('reservation_allowances.get_departement_with_all')->middleware('check.permission:view ReservationAllowance');
    ...
    Route::any('/reservation_allowances/add_reservation_allowances_employess/{type}/{id}', [ReservationAllowanceController::class, 'add_reservation_allowances_employess'])->name('reservation_allowances.add_reservation_allowances_employess')->middleware('check.permission:view ReservationAllowance');
    Route::any('/reservation_allowances/add_reservation_allowances_employes_id/{uuid}', [ReservationAllowanceController::class, 'add_reservation_allowances_employes_id'])->name('reservation_allowances.add_reservation_allowances_employes_id')->middleware('check.permission:view ReservationAllowance');
    Route::any('/reservation_allowances/view_reservation_allowances_employess', [ReservationAllowanceController::class, 'view_reservation_allowances_employess'])->name('reservation_allowances.view_reservation_allowances_employess')->middleware('check.permission:view ReservationAllowance');
